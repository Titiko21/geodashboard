...
# NB : le proxy « courbes de niveau ArcGIS » (2026-07-15) a été retiré le
# jour même : couche premium Esri à jeton + crédits, jeton invalide, service
# introuvable — remplacé par la réexposition des courbes GEE GLO-30 validées.
